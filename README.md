...
> *Previous*
* **Architected** the initial backend for the scheduling website in ASP.NET Core, implementing memory caching to reduce database loads and optimize data flow.
* **Managed** IT maintenance, environment configurations, and core codebase health.
